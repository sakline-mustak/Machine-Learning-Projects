...
│                         finding_donors and configuration for tools like black
│
...
│
└── finding_donors   <- Source code for use in this project.
    │
    ├── __init__.py             <- Makes finding_donors a Python module
    │
